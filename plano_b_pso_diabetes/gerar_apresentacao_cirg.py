...
_, au = box(s, Inches(1.0), Inches(4.15), SW - Inches(2.0), Inches(1.1))
para(au, "Pedro Henrique França  ·  Silas Nunes  ·  Jéssica Maria  ·  José Mario",
     size=20, color=GRAY, align=PP_ALIGN.CENTER, first=True, space_after=6)
para(au, "Prof. Dr. Fernando Buarque de Lima Neto", size=20, color=GRAY, align=PP_ALIGN.CENTER, space_after=0)
_, af = box(s, Inches(1.0), Inches(5.4), SW - Inches(2.0), Inches(1.2))
